...
export class RoomEnvironmentCustom extends Scene {
  constructor() {
    super();

    this.name = 'RoomEnvironmentCustom';
    this.position.y = -3.5;
    ...
    const mainLight = new PointLight(0xffeeff, 500, 28, 2);
    ...
    const light6 = new Mesh(geometry, createAreaLightMaterial(100, 0xffee00));
...
function createAreaLightMaterial(intensity, color = 0xffffff) {
